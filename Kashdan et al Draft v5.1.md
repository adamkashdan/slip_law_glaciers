...
Relict massive ground ice and ice-marginal moraine complexes are preserved across the western Canadian Arctic shelf, including Herschel, Richards, and Pullen islands. These features document Late Pleistocene ice-sheet grounding and shelf-margin dynamics. New direct radiocarbon dates (32,220–25,830 cal yr BP) place the massive ice formation in MIS 3 and the MIS 3/2 transition, pre-dating the previously known constraint of 21,290 cal yr BP. On the same shelf, seismic profiles image moraine ridges interpreted as grounding-zone wedges (GZWs) deposited at the transition between grounded ice and a floating shelf. Typically, warm-based ice streams slide rapidly and deform their beds, which should have destroyed any shallow massive ice. The survival of meter-scale ground ice bodies on Herschel Island instead indicates that subglacial beds remained frozen and stable. We simulate this subglacial environment with a coupled ice flow, sediment transport, and subsurface thermal model. Our simulations show that cold-based or transitional thermal regimes can build GZWs while protecting underlying permafrost from shear. Comparing MIS 4 and MIS 2 retreats shows that the complete lack of MIS 2 GZWs in Mackenzie Bay stems from rapid ice retreat that left insufficient time for grounding-line stabilization.
